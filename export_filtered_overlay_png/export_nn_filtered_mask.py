...
def copy_filtered_overlays(input_folder, output_folder):
    ...
    for subfolder in os.listdir(input_folder):
        ...
        if os.path.isdir(subfolder_path):
            filtered_overlay_path = os.path.join(subfolder_path, "filtered_mask.png")
...
output_folder = "/home/roboticslab/Downloads/OneDrive_2024-02-03/NYCSpan8-9/raw/images_out/2024-04-26_07-29-38/nn_filtered_crack_mask"
