# This script reads the raw images and the concreteMask folder to create filteredRaw folder which has those result images.
import cv2
import os
import configparser
import numpy as np
...
output_dir = config["CrackSegmentation"]["mask_directory"].replace("crackmask", "filteredRaw")
